...
function ExpenseForm(props){
    ...
    const amountChangeHandler = (event) => 
    {
        ...
        // - When doesn't depends on the previous state (For one useState case)
        // setUserInput({
        //     ...userInput,
        ...
        // - When depends on the previous state (For one useState case)
    ...
    const cancelExpenseHandler = (data) =>{
